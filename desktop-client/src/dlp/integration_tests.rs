...
mod integration_tests {
    ...
    async fn test_integration_complete_user_workflow() {
        ...
        let outbound_result = integration
            .scan_outbound_request(&request_body)
            .await
            .unwrap();
    ...
    async fn test_integration_concurrent_operations() {
        ...
        for i in 0..5 {
            ...
            let handle = tokio::spawn(async move {
                ...
                // 并发存储脱敏
                let storage_result = integration_clone
                    .sanitize_for_storage(&content)
                    .await
                    .unwrap();
    ...
    async fn test_integration_error_recovery() {
        ...
        invalid_config
            .custom_patterns
            .push(crate::dlp::integration::CustomPatternConfig {
...
mod api_consistency_tests {
    ...
    async fn test_api_response_format_consistency() {
        ...
        for input in &test_inputs {
            ...
            assert!(
                result.sanitization_stats.blocked_count <= result.sanitization_stats.total_matches
            );
