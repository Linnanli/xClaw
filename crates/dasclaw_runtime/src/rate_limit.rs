...
//! # Provenance
//!
//! Ported verbatim from `desktop-client/ironclaw/src/tools/rate_limiter.rs`
//! as part of ADR-153 step 2 (headless agent runtime). Zero behavior change.
...
use dasclaw_tool::ToolRateLimitConfig;
