...
mod tests {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_ref_creation() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_decrypted_redaction() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_decrypted_expose() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_create_params() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_create_params_name_lowercased() {
        let params = CreateSecretParams::new("SLACK_BOT_TOKEN", "val");
        assert_eq!(params.name, "slack_bot_token");
    }

    #[test]
    fn req_dasclaw_runtime_secrets_create_params_with_expiry() {
        use chrono::Utc;
        let expiry = Utc::now();
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_ref_without_provider() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_ref_serde_roundtrip() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_ref_serde_without_provider() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_credential_location_serde_bearer() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_credential_location_serde_basic() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_credential_location_serde_header() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_credential_location_serde_query() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_credential_location_serde_urlpath() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_credential_location_default_is_bearer() {
        let loc = CredentialLocation::default();
        assert!(matches!(loc, CredentialLocation::AuthorizationBearer));
    }

    #[test]
    fn req_dasclaw_runtime_secrets_credential_mapping_bearer() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_credential_mapping_header() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_credential_mapping_serde_roundtrip() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_decrypted_invalid_utf8() {
        let result = DecryptedSecret::from_bytes(vec![0xFF, 0xFE, 0x00]);
        assert!(result.is_err());
    }

    #[test]
    fn req_dasclaw_runtime_secrets_decrypted_empty() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_decrypted_clone() {
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_secret_debug_redacts_fields() {
        let secret = Secret {
            id: Uuid::nil(),
    ...
    #[test]
    fn req_dasclaw_runtime_secrets_error_display() {
        assert_eq!(
