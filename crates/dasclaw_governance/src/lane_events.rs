//! Lane event taxonomy for governance event streams (W4 #71).
//!
//! Ported from `claw-code/rust/crates/runtime/src/lane_events.rs` (958 LOC).
//!
//! Provides the canonical `lane.*` / `branch.*` event surface plus structured
//! metadata (provenance, ownership, sequence, fingerprint), terminal-event
//! deduplication, and superseded-commit collapsing.
...
impl LaneEvent {
    ...
    pub fn commit_created(
        ...
        // Defensive fallback: LaneCommitProvenance contains only String/Option<String>/Vec<String>
        // and cannot fail to serialize, but `.expect()` is forbidden by the no-panics red line.
        let data = serde_json::to_value(provenance).unwrap_or(Value::Null);
        Self::new(
...
mod tests {
    ...
    #[test]
    fn req_lane_events_71_canonical_lane_event_names_serialize_to_expected_wire_values() {
        let cases = [
    ...
    #[test]
    fn req_lane_events_71_failure_classes_cover_canonical_taxonomy_wire_values() {
        let cases = [
    ...
    #[test]
    fn req_lane_events_71_blocked_and_failed_events_reuse_blocker_details() {
    ...
    #[test]
    fn req_lane_events_71_workspace_mismatch_failure_class_round_trips_in_branch_event_payloads() {
    ...
    #[test]
    fn req_lane_events_71_commit_events_can_carry_worktree_and_supersession_metadata() {
    ...
    #[test]
    fn req_lane_events_71_dedupes_superseded_commit_events_by_canonical_commit() {
    ...
    #[test]
    fn req_lane_events_71_lane_event_metadata_includes_monotonic_sequence() {
    ...
    #[test]
    fn req_lane_events_71_event_provenance_round_trips_through_serialization() {
        let cases = [
    ...
    #[test]
    fn req_lane_events_71_session_identity_is_complete_at_creation() {
    ...
    #[test]
    fn req_lane_events_71_lane_ownership_binding_includes_workflow_scope() {
    ...
    #[test]
    fn req_lane_events_71_watcher_action_round_trips_through_serialization() {
        let cases = [
    ...
    #[test]
    fn req_lane_events_71_is_terminal_event_detects_terminal_states() {
    ...
    #[test]
    fn req_lane_events_71_compute_event_fingerprint_is_deterministic() {
    ...
    #[test]
    fn req_lane_events_71_compute_event_fingerprint_differs_for_different_inputs() {
        let fp1 =
    ...
    #[test]
    fn req_lane_events_71_dedupe_terminal_events_suppresses_duplicates() {
    ...
    #[test]
    fn req_lane_events_71_lane_event_builder_constructs_event_with_metadata() {
        ...
        assert_eq!(
            event.metadata.ownership.as_ref().expect("ownership").owner,
            "bot-1"
        );
    ...
    #[test]
    fn req_lane_events_71_lane_event_metadata_round_trips_through_serialization() {
