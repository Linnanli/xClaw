...
impl ContextBreakdown {
    ...
    pub fn analyze(messages: &[ChatMessage]) -> Self {
        ...
        for message in messages {
            ...
            match message.role {
                crate::messages::Role::System => breakdown.system_tokens += tokens,
                crate::messages::Role::User => breakdown.user_tokens += tokens,
                crate::messages::Role::Assistant => breakdown.assistant_tokens += tokens,
                crate::messages::Role::Tool => breakdown.tool_tokens += tokens,
            }
        }
