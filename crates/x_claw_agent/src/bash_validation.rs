...
//!
//! # Upstream provenance (Phase 3 Step K — cherry-pick drill)
//!
//! - **Source**: `claw-code/rust/crates/runtime/src/bash_validation.rs`
...
//!   syntactic-intent layer over bash commands. It belongs to the agent
...
//!   `Warn`/`Block` into `SafetyDecision::Block`/`SafetyDecision::Redact`.
