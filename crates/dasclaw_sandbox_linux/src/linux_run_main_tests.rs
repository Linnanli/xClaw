...
#[cfg(test)]
use dasclaw_protocol::protocol::FileSystemSandboxPolicy;
#[cfg(test)]
use dasclaw_protocol::protocol::NetworkSandboxPolicy;
#[cfg(test)]
...
fn split_only_filesystem_policy_requires_direct_runtime_enforcement() {
    ...
    let policy = FileSystemSandboxPolicy::restricted(vec![
        dasclaw_protocol::permissions::FileSystemSandboxEntry {
            path: dasclaw_protocol::permissions::FileSystemPath::Special {
                value:
                    dasclaw_protocol::permissions::FileSystemSpecialPath::CurrentWorkingDirectory,
            },
            access: dasclaw_protocol::permissions::FileSystemAccessMode::Write,
        },
        dasclaw_protocol::permissions::FileSystemSandboxEntry {
            path: dasclaw_protocol::permissions::FileSystemPath::Path { path: docs },
            access: dasclaw_protocol::permissions::FileSystemAccessMode::Read,
        },
    ]);
...
fn root_write_read_only_carveout_requires_direct_runtime_enforcement() {
    ...
    let policy = FileSystemSandboxPolicy::restricted(vec![
        dasclaw_protocol::permissions::FileSystemSandboxEntry {
            path: dasclaw_protocol::permissions::FileSystemPath::Special {
                value: dasclaw_protocol::permissions::FileSystemSpecialPath::Root,
            },
            access: dasclaw_protocol::permissions::FileSystemAccessMode::Write,
        },
        dasclaw_protocol::permissions::FileSystemSandboxEntry {
