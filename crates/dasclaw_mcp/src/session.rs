...
//!
//! Migrated from `ironclaw::tools::mcp::session` in F3.2 phase 3 PR 6-α
//! (#661). No behaviour change: this module has zero ironclaw-specific
//! dependencies and is byte-for-byte the same logic.
