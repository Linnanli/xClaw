...
export interface ClientModelProviderModel {
  modelId: string;
  displayName: string;
  description?: string;
  provider: string;
...
export interface ClientModelProviderConfig {
  models: ClientModelProviderModel[];
...
export type ClientEvent =
  ...
  | { type: 'modelProvider.list'; payload: Record<string, never> }
  | { type: 'modelProvider.selectForNextTurn'; payload: { modelId: string } }
...
export type ServerEvent =
  ...
  | { type: 'modelProvider.changed'; payload: ClientModelProviderConfig }
